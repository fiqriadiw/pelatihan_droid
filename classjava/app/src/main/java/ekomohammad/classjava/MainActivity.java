...
//      showString += arrBarang[1].toString();
    ...
    public void initBarang(){
        ...
        arrBarang[2] = new Barang("Monitor", Barang.ELEKTRONIK, 300000);
        arrBarang[3] = new Barang("Pentil", Barang.NON_ELEKTRONIK, 10000);
        arrBarang[4] = new Barang("Klep", Barang.NON_ELEKTRONIK, 1500000);
        arrBarang[5] = new Barang("Ruji", Barang.NON_ELEKTRONIK, 250000);
        arrBarang[6] = new Barang("Tromol", Barang.NON_ELEKTRONIK, 50000);
        arrBarang[7] = new Barang("Velg", Barang.NON_ELEKTRONIK, 800000);
        arrBarang[8] = new Barang("Ban", Barang.NON_ELEKTRONIK, 350000);
        arrBarang[9] = new Barang("Oli", Barang.NON_ELEKTRONIK, 120000);
    }
}
